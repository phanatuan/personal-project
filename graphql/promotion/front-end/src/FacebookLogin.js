...
class FaceookSignIn extends Component {
  constructor() {
    super();
    this.onFacebookLogin = this.onFacebookLogin.bind(this);
    this.appId = 'APP_ID_FROM_FACEBOOK_HERE';
  ...
  componentDidMount() {
    ...
    this.props.mutate({variables: {code: this.code}}).then(response => {
  ...
  render() {
    ...
    return (
      <a href='/facebook-login' onClick={this.onFacebookLogin}><i className={icon}></i> Faacebook </a>
    );
  }
}
